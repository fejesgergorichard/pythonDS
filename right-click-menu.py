...
class Main(tk.Frame):
    def __init__(self, master):
        ...
        self.tree = ttk.Treeview(self.master, columns=['col A','col B','col C'])
    ...
    def clickbtn(self):
        ...
        self.tree.insert('', 'end', values=[text, text, text])
        self.num += 1
...
class RightClick:
    ...
    def delete(self):
        if self.tree_item:
            #self.tree_item = 'hejj hejj'
            print(app.tree.focus())
            print(type(app.tree.focus()))
            app.tree.insert('', 'end', text='text')
    str
    def hello(self):
        print ('hello!')
